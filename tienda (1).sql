...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-03-2023 a las 03:01:03
...
(1, 'teclado', 'teclado para gaming, trabajo, uso regular'),
(2, 'tenis', 'tenis para correr, tenis para jugar fut, tenis para jugar basketball'),
(3, 'ropa ', 'variedad de ropa, moda, belleza, deportes'),
(4, 'joyeria', 'anillos, collares, aretes, piercings'),
(5, 'gorras', 'gorras deportivas, casuales, playeras');
